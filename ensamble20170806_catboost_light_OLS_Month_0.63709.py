...
XGB1_WEIGHT = 0.80  # Weight of first in combination of two XGB models

BASELINE_PRED = 0.0115   # Baseline based on mean of training data, per Oleg


#
#   Aug. 6th OSX --> 0.0644666
#
#   XGB_WEIGHT = 0.6415
#   BASELINE_WEIGHT = 0.0050
#   OLS_WEIGHT = 0.0828
...
#  Aug. 7th OSX
# catboost + LightGBM + OLS --> 0.0645790
# much worser
...
df_train = df_train[df_train["Month"]<10]
df_val = df_train[df_train["Month"]>=10]
...
sample = trainCls.makeSampleForTesting()
...
print("   ...")
print("   add transaction date 4q .....")
print("")
df_test['transactiondate'] = '2016-10-01'
...
val_df = train_df[train_df["Month"]>=10]
...
print('After removing outliers and adding Month:')
print('Shape train: {}\nShape test: {}'.format(x_train.shape, x_test.shape))

print("-"*20)
#print(" train columns name ......")
...
print( "\nCombined catboost/LGB/baseline predictions:" )
...
submission.to_csv('sub_catboost{}.csv'.format(datetime.now().strftime('%Y%m%d_%H%M%S')), index=False)
...
# version 106: Try raising OLS_WEIGHT to .0856
