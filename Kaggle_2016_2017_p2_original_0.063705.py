...
BASELINE2017_PRED = 0.01675

BASELINE_PRED = BASELINE2017_PRED

#   Aug. 7th OSX ---> 0.0643995
# Parameters
#XGB_WEIGHT = 0.641
#BASELINE_WEIGHT = 0.0050
#OLS_WEIGHT = 0.0828
...
trainCls = trainClass()
train = trainCls.readTrain2017()
prop = trainCls.readProp2017()
...
submission = pd.read_csv("output/sub_kgle_orginal20171006_092125.csv")
...
submission.to_csv('output/sub_kgle_orginal{}.csv'.format(datetime.now().strftime('%Y%m%d_%H%M%S')), index=False)
