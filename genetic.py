...
def main():
    ...
    print("Drop outliers from train / xtrain ..")
    ...
    print("Start genetic valuation....")
    sub = trainCls.readSampleSub()
    datadir="/Users/donchan/Documents/myData/KaggleData/zillow/output"
    submission_file=os.path.join(datadir,"gp_{}.csv".format( datetime.now().strftime("%Y%m%d%H%M%S")  ) )
    testpreds = GP(test)
